<<<<<<< Updated upstream:src/main/java/net/Gamesco/Headcontrol/client/HeadHudLayer.java
...
import net.Gamesco.MovementDemo.MovementDemo; // <- ggf. anpassen an euren Main-Mod-Class-Namen/MODID
import net.minecraft.resources.ResourceLocation;
import net.minecraftforge.api.distmarker.Dist;
import net.minecraftforge.client.event.AddGuiOverlayLayersEvent;
import net.minecraftforge.client.gui.overlay.ForgeLayeredDraw;
...
@Mod.EventBusSubscriber(modid = MovementDemo.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class HeadHudLayer {

    public static final ResourceLocation LAYER_ID =
            ResourceLocation.fromNamespaceAndPath(MovementDemo.MOD_ID, "headcontrol_hud");
...
>>>>>>> Stashed changes:src/main/java/net/Gamesco/MovementDemo/client/HeadHudLayer.java
